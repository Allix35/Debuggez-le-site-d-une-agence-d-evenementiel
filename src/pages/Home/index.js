    ...
    <>
        ...
        <section className="ServicesContainer">
          ...
          <div className="ListContainer">
            <ServiceCard imageSrc="/images/priscilla-du-preez-Q7wGvnbuwj0-unsplash1.png">
              ...
              Nous organisons vos diners et soirées d’entreprise pour valoriser votre société.
            </ServiceCard>
            <ServiceCard imageSrc="/images/hall-expo.png">
              <h3>Conférences</h3>
              Organisation de conférences adaptées à votre demande et votre audience.
            </ServiceCard>
            <ServiceCard imageSrc="/images/sophia-sideri-LFXMtUuAKK8-unsplash1.png">
              <h3>Expérience digitale</h3>
              Conseil en réalité virtuelle, augmentée et immersive pour des événements innovants.
            </ServiceCard>
          </div>
        </section>
      ...
      <footer className="row">
        ...
        <div className="col description">
          <Logo size="large" />
          <p>
            Une agence événementielle propose des prestations de service spécialisées
            dans la conception et l&apos;organisation de divers événements tels que
            des événements festifs, des manifestations sportives et culturelles,
